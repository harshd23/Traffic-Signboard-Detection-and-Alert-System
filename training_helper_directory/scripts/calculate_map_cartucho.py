...
parser.add_argument('--labels', help='Path to the labelmap file', default='D:/Traffic SignBoard Recognition using Deep Learning/ssd-tflite/SSD-Mobilenet-TFlite/labelmap1.txt')
parser.add_argument('--outdir', help='Output folder to save results in', default='D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/ground-truth/output/output.txt')
...
for i, iou_thresh in enumerate(iou_threshes):
    ...
    with open('D:/Traffic SignBoard Recognition using Deep Learning/training_helper_directory/scripts/main.py', 'r') as f:
        data = f.read()
    ...
    with open('D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/ground-truth/output/output.txt', 'r',) as f:
        for line in f:
            if '%' in line:
    ...
    newpath = os.path.join('D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/ground-truth/output/output.txt','output_iou_%.2f' % iou_thresh)
    print(newpath)
