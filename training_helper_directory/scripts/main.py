...
GT_PATH = os.path.join('D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/ground-truth')
DR_PATH = os.path.join('D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join('D:/Traffic SignBoard Recognition using Deep Learning/SSD MobileNet V1 FPN 640x640/input/images-optional')
